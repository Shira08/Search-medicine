<nav class="navbar navbar-expand-lg bg-white shadow-sm navbar-light sticky-top">
    <a href="" class=" d-flex  mx-4">
        <h5 class="text-primary  mb-0">Pharmacie Dashboard</h5>
    </a>
    ...
    aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent" >
        <div class="navbar-nav align-items-center ms-auto" >
            <a href="{{route('dashboard-pharmacy')}}" class="{{Request::is('dashboard-pharmacy')?'active':''}} nav-link me-4 btn">
                <i class="fa fa-tachometer-alt me-lg-2"></i>
                <span class="">Dashboard</span>
            </a>
    
            <a href="{{route('list.medicine')}}" class="{{Request::is('dashboard-medicine')?'active':''}} nav-link btn ">
                <i class="fa-solid fa-tablets me-2"></i>
                <span class="">Médicaments</span> <!-- ajout d'illustration-->
            </a>

        ...
        <div class="row g-4">
            ...
            <div class="col-lg-10 mx-auto grid-margin stretch-card">
                <div class="bg-white shadow rounded h-100 p-4">
                    ...
                    <h4 class="mb-4 text-secondary">Modifier une pharmacie</h4>
                    <h4><a href="{{route('display.pharmacy')}}">Revenir à la liste</a></h4>
                    </div>
                    <form action="{{route('update.pharmacy')}}" method="post">
                        ...
                        <button type="submit" name="" class="btn btn-primary col-12">Modifier une
                            pharmacie</button>
